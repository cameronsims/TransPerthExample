...
namespace transperth {
    ...
    struct TrainStation {
        ...
        typedef struct {
            ...
            /// The time it takes to get from one to the other (in minutes)
            int weight;
        } Link;
    ...
    void TrainStation_connect(TrainStation* left, TrainStation* right, int weight, TrainStation::ConnectionType type);
